%Bidiagonal decomposition  of Wronskian matrix of Negative Binomial basis 
...
%BD(JWJ) Negative Binomial Basis
...
IB2=TNInverseExpand(BDA);
IB=J*IB2*J %Aplicamos Corolario
IM=inv(A)
